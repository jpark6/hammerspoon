...
hs.hotkey.bind({'⌥','⇧'}, '6',moveWindowToMonitor(6))
hs.hotkey.bind({'⌥','⇧'}, '7',moveWindowToMonitor(7))
hs.hotkey.bind({'⌥','⇧'}, '8',moveWindowToMonitor(8))
hs.hotkey.bind({'⌥','⇧'}, '9',moveWindowToMonitor(9))
-- 현재 윈도우 모니터 이동End
